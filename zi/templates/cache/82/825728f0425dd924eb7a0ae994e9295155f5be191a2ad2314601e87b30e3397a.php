...
/* selling/pos.twig */
class __TwigTemplate_a515d7d33fd0610285e4cca9e32268a4b7d1f47192eee19bcd280cabe466e0ad extends Twig_Template
{
    ...
    \$(\"#form_payment, input[name=bayar]\").on('keydown', function (e) {
        switch(e.which) {
            case 116:
                ...
                if (parseInt(vbayar) <= parseInt(total)) {
                    Messenger().post({
    ...
    <div id=\"form_payment\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\">
        ...
        echo " <small class=\"display-block\">Mohon diisi dengan teliti detail pembayaran tagihan</small></h6>
                    ...
                    <div class=\"modal-footer\">
                        ...
                        <button type=\"button\" class=\"btn btn-primary\">Bayar [F5]</button>
                    </div>
...
";
    ...
    {
        return array (  694 => 550,  659 => 518,  652 => 514,  638 => 503,  626 => 494,  617 => 488,  604 => 478,  596 => 473,  582 => 462,  573 => 456,  565 => 451,  543 => 432,  526 => 420,  515 => 413,  512 => 412,  466 => 369,  443 => 346,  426 => 332,  389 => 298,  372 => 284,  328 => 243,  311 => 229,  282 => 203,  269 => 193,  249 => 176,  224 => 154,  220 => 153,  216 => 152,  80 => 19,  72 => 14,  68 => 13,  64 => 12,  60 => 11,  56 => 10,  52 => 9,  47 => 8,  44 => 7,  38 => 4,  33 => 3,  30 => 2,  11 => 1,);
    }
}
...
/*                                 return;*/
/*                             }*/
/*                             window.open("{{ print_nota }}"+"/"+data.kode_invoice);*/
/*                         });*/
/*                     },*/
/*                     complete: function() {*/
/* */
...
/* {% endblock %}*/
/* {% block content %}*/
/*     <form id="form-pos" class="form-horizontal" action="{{url_submit}}" method="POST" role="form">*/
/* */
/*         <div class="row">*/
/*             <div class="col-sm-12">*/
/*                 <div class="block-inner">*/
...
/*                                     <label>Nomer Pendaftaran:</label>*/
/*                                     <input type="text" placeholder="Pasien No.Reg" class="form-control"*/
/*                                            name="reg_no" value="{{ data.reg_no }}" readonly/>*/
/*                                 </div>*/
/*                                 <div class="col-sm-3">*/
/*                                     <label>Pasien nama:</label>*/
/*                                     <input type="text" placeholder="Pasien Nama" class="form-control"*/
/*                                            name="pasien_nama" value="{{ data.pasien_nama }}" readonly/>*/
/*                                 </div>*/
/*                                 <div class="col-sm-6">*/
/*                                     <label>Pencarian Pasien:</label>*/
/*                                     <div class="input-group input-group">*/
...
/*                                     <label>Pasien Alamat:</label>*/
/*                                     <textarea rows="5" placeholder="Pasien Alamat" class="form-control"*/
/*                                               name="pasien_alamat" readonly>{{ data.pasien_alamat }}</textarea>*/
/*                                 </div>*/
/*                                 <div class="col-sm-6">*/
/*                                     <label>Tagihan [F4]:</label>*/
/*                                     <input type="hidden" placeholder="Jenis Tagihan"*/
...
/*                                     <label>Jenis Pasien:</label>*/
/*                                     <input type="text" placeholder="Jenis Pasien" class="form-control"*/
/*                                            name="pasien_jenis" value="{{ data.pasien_jenis }}" readonly/>*/
/*                                     <span class="help-block">jenis pasien saat registrasi. e.g SWADANA, BPJS ASKES, STMJ, JAMKESMAS</span>*/
/*                                 </div>*/
/*                                 <div class="col-sm-3">*/
/*                                     <label>Dokter :</label>*/
