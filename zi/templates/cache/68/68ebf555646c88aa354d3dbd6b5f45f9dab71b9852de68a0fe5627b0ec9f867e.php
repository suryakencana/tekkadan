...
/* item/form_item.twig */
class __TwigTemplate_7d229a7863d1afb02bd849d97f55539bc1b9e9a848b624c19a612d7bfc8ec6bb extends Twig_Template
{
    ...
    <script type=\"text/javascript\">
        ...
        echo "',
                    ...
                    quietMillis: 100,
                    data: function (term, page) {
                        return { aktif: 'TRUE', sort:'nama', order: 'asc', search: term, offset: (page - 1) * 15, limit: 15 };
                    },
                    results: function (data, page) {
                        var more = (page * 15) < data.total;
                        return {results: data.rows, more: more};
