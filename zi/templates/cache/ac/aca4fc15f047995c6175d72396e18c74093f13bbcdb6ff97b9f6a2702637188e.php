...
/* pricelist/grid_pricelist.twig */
class __TwigTemplate_4fadcf0a279c81a09a46f720e5ac6b4734a80e68628cf6f73215e87260e1be8b extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("principal/index.twig", "pricelist/grid_pricelist.twig", 1);
        $this->blocks = array(
...
";
    ...
    {
        return "pricelist/grid_pricelist.twig";
    }
...
/*                                 progressMessage: 'Sedang proses simpan data...'*/
/*                             }, {*/
/*                                 url: "{{  url_remove }}/" + rows[0].price_list_nama,*/
/*                                 method: "POST",*/
/*                                 success: function() {*/
...
/*                         return;*/
/*                     case ACTION_EDIT:*/
/*                         window.location = "{{  url_edit }}/" + rows[0].price_list_nama;*/
/*                         return;*/
/*                 }*/
/*             } else {*/
/*                 Messenger().post({*/
