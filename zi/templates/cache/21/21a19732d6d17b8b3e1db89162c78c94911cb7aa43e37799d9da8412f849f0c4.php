...
class __TwigTemplate_fdcac62d6127f197ccf152f9e81d671e6adab8546c04c81f567405d26ee0d36f extends Twig_Template
{
...
<div id=\"body\">
    ...
    <div id=\"content\">
        ...
        echo "</strong> - Kasir: ";
        echo twig_escape_filter($this->env, (isset($context["kasir"]) ? $context["kasir"] : null), "html", null, true);
        echo "</td>
                </tr>
        ...
        echo "</strong></td>
                    <td>Dokter: <strong>";
        // line 36
        echo twig_escape_filter($this->env, (isset($context["dokter"]) ? $context["dokter"] : null), "html", null, true);
        echo "</strong></td>
                </tr>
            </table>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
            ...
            echo "</td>
                        <td style=\"text-align: center\">";
            // line 63
            echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute($context["row"], "actual_qty", array()), 0, ".", ","), "html", null, true);
            echo "</td>
            ...
            echo "</td>
                        <td class=\"change_order_total_col\">Rp. ";
            // line 66
        ...
        echo "
                ...
                <tr>
                    ...
                    <td class=\"change_order_total_col\"><strong>Rp. ";
        // line 74
        ...
        echo "</strong></td>
                ...
                <tr>
                    ...
                    <td class=\"change_order_total_col\"><strong>Rp. ";
        // line 79
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, (isset($context["payment"]) ? $context["payment"] : null), 2, ".", ","), "html", null, true);
        echo "</strong></td>
                </tr>
                <tr>
                    <td colspan=\"3\" style=\"text-align: right;\"></td>
                    ...
                    <td class=\"change_order_total_col\"><strong>Rp. ";
        // line 84
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, ((isset($context["payment"]) ? $context["payment"] : null) - (isset($context["amount"]) ? $context["amount"] : null)), 2, ".", ","), "html", null, true);
        echo "</strong></td>
                </tr>
            </table>
        </div>
...
";
    ...
    {
        return array (  171 => 84,  163 => 79,  155 => 74,  148 => 69,  139 => 66,  135 => 65,  131 => 64,  127 => 63,  121 => 62,  117 => 61,  114 => 60,  110 => 59,  91 => 43,  81 => 36,  77 => 35,  70 => 31,  64 => 30,  55 => 26,  51 => 25,  39 => 16,  28 => 8,  19 => 1,);
    }
}
...
/*                     <td><strong>{{price_list}}</strong> - Kasir: {{kasir}}</td>*/
/*                 </tr>*/
/* */
/*                 <tr>*/
...
/*                     <td>Dokter: <strong>{{ dokter }}</strong></td>*/
/*                 </tr>*/
/*             </table>*/
/* */
/*             <table style="width: 100%; border-top: 1px solid black; border-bottom: 1px solid black; font-size: 5pt;">*/
...
/*                         <td class="change_order_total_col">Rp. {{ row.amount | number_format(2, '.', ',')}}</td>*/
/*                     </tr>*/
/*                 {% endfor %}*/
/* */
/*                 </tbody>*/
...
/*                     <td colspan="3" style="text-align: right;"></td>*/
/*                     <td colspan="2" style="text-align: right;"><strong>Total:</strong></td>*/
/*                     <td class="change_order_total_col"><strong>Rp. {{amount | number_format(2, '.', ',')}}</strong></td>*/
/*                 </tr>*/
/*                 <tr>*/
/*                     <td colspan="3" style="text-align: right;"></td>*/
/*                     <td colspan="2" style="text-align: right;"><strong>Bayar:</strong></td>*/
/*                     <td class="change_order_total_col"><strong>Rp. {{payment | number_format(2, '.', ',')}}</strong></td>*/
/*                 </tr>*/
/*                 <tr>*/
/*                     <td colspan="3" style="text-align: right;"></td>*/
/*                     <td colspan="2" style="text-align: right;"><strong>Kembali:</strong></td>*/
/*                     <td class="change_order_total_col"><strong>Rp. {{ (payment - amount) | number_format(2, '.', ',')}}</strong></td>*/
/*                 </tr>*/
/*             </table>*/
/*         </div>*/
/* */
