...
/* item/form_item.twig */
class __TwigTemplate_f8ea39f1e3d6b3f5c149bade7e4871fcade7980f57689e423d7c2d6e37b67d7f extends Twig_Template
{
                            ...
                            <div class=\"row\">
                                <div class=\"col-sm-6\">
                                    <label class=\"checkbox-inline\">
                                        #Batch No
                                        <input type=\"checkbox\" name=\"has_batch_no\" class=\"styled\" ";
        // line 324
        if (($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "has_batch_no", array()) > 0)) {
            echo "checked=\"checked\"";
        }
        echo " />
                                        <span class=\"help-block\">Digunakan untuk item yang mempunyai tanggal kadaluarsa</span>
                                    </label>
                                </div>
                            </div>
                        </div>
...
";
    ...
    {
        return array (  492 => 348,  480 => 339,  472 => 334,  457 => 324,  445 => 315,  420 => 293,  409 => 285,  396 => 275,  371 => 253,  359 => 244,  344 => 234,  336 => 229,  321 => 219,  312 => 213,  304 => 212,  287 => 198,  278 => 192,  274 => 190,  268 => 187,  262 => 184,  259 => 183,  257 => 182,  249 => 177,  246 => 176,  243 => 175,  219 => 155,  202 => 141,  175 => 117,  158 => 103,  131 => 79,  114 => 65,  86 => 40,  69 => 26,  47 => 7,  43 => 6,  38 => 5,  35 => 4,  30 => 2,  11 => 1,);
    }
}
...
/*                                 <div class="col-sm-4">*/
/*                                     <label>Default Warehouse(gudang):</label>*/
/*                                     <input type="hidden" name="default_gudang" class="default_gudang" value="{{data.default_gudang}}"/>*/
/*                                 </div>*/
/*                             </div>*/
/*                         </div>*/
/*                         <div class="form-group">*/
...
/*                                     <label class="checkbox-inline">*/
/*                                         #Batch No*/
/*                                         <input type="checkbox" name="has_batch_no" class="styled" {% if data.has_batch_no > 0 %}checked="checked"{% endif %} />*/
/*                                         <span class="help-block">Digunakan untuk item yang mempunyai tanggal kadaluarsa</span>*/
/*                                     </label>*/
/*                                 </div>*/
/*                             </div>*/
